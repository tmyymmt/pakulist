...
|   |   `-- 20260812_08_copy_candidate_timeline
|   |       |-- 20260812_1430-handover.md # 時系列コピー候補検知の引継ぎ記録
|   |       `-- work_plan.md         # 時系列コピー候補検知の作業計画
|   |-- research                     # 調査結果を格納
...
|       |   `-- copy_candidate_timeline.md # UC-03の起点・後発候補・時刻差の設計
